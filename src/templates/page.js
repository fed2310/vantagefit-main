                    ...
                    <div className="elementor-inner">
                        <div className="elementor-section-wrap">
                            <section className="breadcrumb_area breadcrumb_area_two vc-btn-gradient-color vc-btn-gradient-general"> 
                                <img width="570" height="512" className="breadcrumb_shap hidden-xs lozad" src="https://res.cloudinary.com/vantagecircle/image/upload/v1600424606/VantageFit/website/lines-vfit-compress-2.png" alt="lines" />
                                <div className="marketinglanding">
                                    <img width="300" height="128" className="breadcrumb_pulse hidden-xs lozad" src="https://res.cloudinary.com/vantagecircle/image/upload/w_300/v1580904957/VantageFit/website/heart-lines.png" alt="pulse" />
                                </div>
